...
WebUI.setText(findTestObject('WEB/Registration/field-account'), 'agungpriyadi2')

WebUI.setText(findTestObject('WEB/Registration/field-Password'), 'Laskar1234560')
...
loginError.addProperty('xpath', ConditionType.EQUALS, '//div[@role=\'alert\']//p[contains(text(),\'Account or password is not correct\')]')

boolean isVisible = WebUI.waitForElementVisible(loginError, 10, FailureHandling.OPTIONAL)

WebUI.comment('Login Error Visible : ' + isVisible)

// ========================
// ASSERTION
// ========================
WebUI.verifyEqual(isVisible, true)

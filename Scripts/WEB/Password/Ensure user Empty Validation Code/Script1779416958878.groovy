...
WebUI.setText(findTestObject('WEB/Password/Page_Forgot Password/txtField_Email'), 'agung.priyadi@gtech.digital')
...
WebUI.setText(findTestObject('WEB/Password/Page_Forgot Password/txtField_Validation Code'), '')

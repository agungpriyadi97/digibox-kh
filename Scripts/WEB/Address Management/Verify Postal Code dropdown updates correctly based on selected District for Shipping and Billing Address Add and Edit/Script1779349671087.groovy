...
// CHANGE ADDRESS
// ========================
WebUI.scrollToElement(findTestObject('WEB/Checkout/Address/Address Ship To/btn-change'), 5)

WebUI.waitForElementVisible(findTestObject('WEB/Checkout/Address/Address Ship To/btn-change'), 30)

WebUI.waitForElementClickable(findTestObject('WEB/Checkout/Address/Address Ship To/btn-change'), 30)

WebUI.enhancedClick(findTestObject('WEB/Checkout/Address/Address Ship To/btn-change'))
...
WebUI.waitForElementVisible(findTestObject('WEB/Checkout/Address/Address Ship To/field_Address'), 30)

WebUI.clearText(findTestObject('WEB/Checkout/Address/Address Ship To/field_Address'))

WebUI.setText(findTestObject('WEB/Checkout/Address/Address Ship To/field_Address'), updateAddress)

WebUI.clearText(findTestObject('WEB/Checkout/Address/Address Ship To/input_ZipPostal Code'))

WebUI.setText(findTestObject('WEB/Checkout/Address/Address Ship To/input_ZipPostal Code'), updateCode)

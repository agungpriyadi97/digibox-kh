...
// Province
WebUI.waitForElementClickable(findTestObject('Checkout/Address/Address Ship To/input_Province'), 30)
WebUI.enhancedClick(findTestObject('Checkout/Address/Address Ship To/input_Province'))

WebUI.waitForElementVisible(findTestObject('Checkout/Address/Address Ship To/li_Phnom Penh Capital_Province'), 30)
WebUI.enhancedClick(findTestObject('Checkout/Address/Address Ship To/li_Phnom Penh Capital_Province'))

// City
WebUI.waitForElementClickable(findTestObject('Checkout/Address/Address Ship To/input_Select Province'), 30)
WebUI.enhancedClick(findTestObject('Checkout/Address/Address Ship To/input_Select Province'))

WebUI.waitForElementVisible(findTestObject('Checkout/Address/Address Ship To/li_Khan Chamkar Mon_Select_Province'), 30)
WebUI.enhancedClick(findTestObject('Checkout/Address/Address Ship To/li_Khan Chamkar Mon_Select_Province'))

// District
WebUI.waitForElementClickable(findTestObject('Checkout/Address/Address Ship To/input_Districts'), 30)
WebUI.enhancedClick(findTestObject('Checkout/Address/Address Ship To/input_Districts'))

WebUI.waitForElementVisible(findTestObject('Checkout/Address/Address Ship To/li_Sangkat Tonle Basak_Districts'), 30)
WebUI.enhancedClick(findTestObject('Checkout/Address/Address Ship To/li_Sangkat Tonle Basak_Districts'))
